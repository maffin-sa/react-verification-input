...
| stripInvalidChars     | Boolean   | `false`  | Strip any characters not contained within `validChars` on input before other validation (ex. user pastes in `012-345`, the `-` will be removed before length validation)                                                                                                                                                                                            |
